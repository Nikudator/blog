...
<div class="post-view">
    ...
    <div>
    <span class="pull-left text-capitalize">Автор: <?= $model->author->username; ?> Опубликовано: <?= $model->getDate();?>  <?= $post->getDate()===$post->getUpdate() ? 'Обновлено: '.$post->getUpdate() : false ;?></span>
    </div>
</div>
